...
<html xmlns:v="urn:schemas-microsoft-com:vml">
	...
	<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<table style="display:none!important;">
			<tbody><tr>
				<td>
					<div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">E2W Admin!</div>
				</td>
			</tr>
			</tbody></table>
		<!-- pre-header end -->
												...
												<tr>
													<td align="center" height="70" style="height:70px;">
														<a href="" style="display: block; border-style: none !important; border: 0 !important;">
															<img width="100" border="0" style="display: block; width: 100px;" src="{{ asset('/images/EW-Logo.png') }}" alt="">
														</a>
													</td>
												</tr>
											</tbody>
							...
							<tbody>
								<tr>
									<td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
										...
										<div style="line-height: 35px">Thank you for contacting us!</div>
									</td>
								</tr>
											...
											<tbody>
												<tr>
													<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
														...
														<p style="line-height: 24px; margin-bottom:15px;">{{ $contact->first_name }}</p>

														<p style="line-height: 24px;margin-bottom:15px;">
															Thanks for reaching out to us and showing interest in participating in our vacation to {{ $participant->trip->trip_location }}. We will keep you informed every step of the way until we take off.
														</p>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="2a2e36">
			...
			<tbody>
				<tr>
					<td align="center" style="background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url({{ $participant->trip->trip_photo != null ? asset('storage/' . str_ireplace('public/', '', $participant->trip->trip_photo)) : '/images/skyline.jpg' }})">
												...
												<tr>
													<td align="center">
														<table border="0" align="center" cellpadding="0" cellspacing="0" class="container580">
															<tbody><tr>
																<td align="center" style="color: #cccccc; font-size: 35px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
																	<!-- section text ======-->

																	<div style="line-height: 26px">
																		{{ strtoupper($participant->trip->trip_location) }}
																		<br>
																		{{ strtoupper($participant->trip->trip_year) }}
																	</div>
																</td>
															</tr>
															</tbody>
												...
												<tr>
													<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
														...
														<div style="line-height: 22px;">
															<a href="{{ route('location.show', $participant->trip->id) }}" style="color: #fff; text-decoration: none;">VIEW THE TRIP</a>
														</div>
													</td>
												</tr>
														...
														<table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
															...
															<tbody>
																<tr>
																	<!-- logo -->
																	<td align="left">
																		<a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="{{ asset('/images/EW-Logo.png') }}" alt=""></a>
																	</td>
																</tr>
																...
																<tr>
																	<td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
																		<div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
																			...
																			Email us: <br> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">jackson521961@gmail.com</a>
